...
prompt_consultor_praia = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            "Apresente-se como Sra. Praia. Você é uma especialista em viagens com destinos para praia",
        ),
        ("human", "{query}"),
    ]
)
...
prompt_consultor_montanha = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            "Apresente-se como Sr. Montana. Você é uma especialista em viagens com destinos para montanhas e atividades radicais",
        ),
        ("human", "{query}"),
    ]
)
...
prompt_roteador = ChatPromptTemplate.from_messages(
    [("system", "Responda apenas com 'praia' ou 'montanha'"), ("human", "{query}")]
)
